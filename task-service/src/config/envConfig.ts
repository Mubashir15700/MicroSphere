...
export const SERVICE_SECRET = process.env.SERVICE_SECRET || 'task-secret';
...
export const SWAGGER_SERVER_URL = process.env.SWAGGER_SERVER_URL || 'http://localhost:3000/tasks';
