...
export default function AdminDashboard() {
    ...
    return (
        <div className="max-w-5xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-md shadow-md mt-10 space-y-10">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Admin Dashboard</h1>

            {/* Summary Section */}
            <div className="flex justify-around bg-gray-100 dark:bg-gray-700 rounded-md p-6 text-center">
                <div>
                ...
                {users.length === 0 ? (
                    ...
                    <ul className="space-y-3">
                        {users.map((user) => (
                            <li
                                key={user.id}
                                className="p-3 border rounded-md border-gray-300 dark:border-gray-700 flex justify-between items-center"
                            >
                                <div>
